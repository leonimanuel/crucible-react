					...
					?
						<React.Fragment>
							...
							<p>
								...
								<br/>
								Facts are the heart of Crucible and the currency with which comments are created. Facts can come from pretty much anywhere; you can gather facts from any online source using the <a style={{"text-decoration": "underline"}} href="https://chrome.google.com/webstore/detail/crucible/npbeagaahjohdgibaddadkhcffnedcnh?authuser=1" target="_blank">Crucible Chrome extension</a> as well as from articles you read in Crucible or from other users’ comments. To use one of the facts you’ve gathered in support of a comment, open the “Facts” section of the sidebar once you’ve started a comment, find your desired fact, and drag it into your comment. Once you have at least one supporting fact, you’re ready to post and unlock the discussion's forum. Each fact that you use in support of a comment brings you one step closer to meeting your daily facts streak, whose progress you can see up top. Hitting your daily streaks for both facts and reviews (we'll cover those in a bit) will unlock all discussion forums for the day.
							</p>
