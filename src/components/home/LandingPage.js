...
class LandingPage extends Component {
  ...
  //   let blob = document.querySelector("#blob")
	...
	renderText = () => {
		...
		let text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer a nisl auctor, mattis nulla sit amet, bibendum mi. Donec nec pretium nulla. Suspendisse potenti. Maecenas eget diam sed felis feugiat aliquet. Nunc nunc risus, tempor ac nibh quis, volutpat malesuada metus. Cras rutrum gravida erat, non lobortis lorem ornare nec. Cras viverra varius purus, ornare dignissim ante rutrum auctor. In eget lectus pellentesque, eleifend nisi at, pretium ipsum. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia curae; Cras egestas ultrices justo, vel egestas tellus pulvinar vel. Donec lectus sapien, cursus iaculis ultricies nec, ullamcorper vel felis. Fusce consectetur convallis nunc sed volutpat. Sed non aliquet lectus. Nam aliquet, nulla non sollicitudin tristique, leo magna feugiat erat, eu congue lectus massa rutrum est. Sed egestas maximus bibendum. Phasellus dui augue, pulvinar sed mollis eget, elementum id nulla."
		// let text = "Crucible was designed as an antidote to modern public discourse; a bulwark against the empty rhetoric that seems to fill up more and more of our airwaves and news feeds. It's predicated on the idea that we owe it to ourselves and to each other to know, without hesitation, why we stand where we stand on the issues and that the ground beneath our feet is solid.\n\nOn Crucible, the right to be heard is not a given; it's earned. It's a place where research and accuracy is rewarded and the lazy and disingenuous discouraged. Where mistruth, generalizations and lies are burned away by the heat of scrutiny so that truth can shine through.\n\nConversation is the lifeblood of society. Truth is its foodstuff, misinformation is its poison. In these next few months, when the two start getting all jumbled up, outpace and cut through the noise, with Crucible." 
