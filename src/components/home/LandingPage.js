...
class LandingPage extends Component {
	...
	renderText = () => {
		...
		let text = "Crucible was designed as an antidote to modern public discourse; a bulwark against the empty rhetoric that seems to fill up the more and more of our airwaves and news feeds. It's predicated on the idea that we owe it to ourselves and to each other to know, without hesitation, why we stand where we stand on the issues and that the ground beneath our feet is solid.\n\nOn Crucible, the right to heard is not a given; it's earned. It's a place where research and accuracy is rewarded and the lazy and disingenuous punished. Where mistruth, generalizations and lies are burned away by the flames of scrutiny so that truth can shine through.\n\nConversation is the lifeblood of society, truth; its foodstuff, misinformation; its poison. In these next few months, when the two start getting all jumbled up, outpace and cut through the noise, with Crucible." 
